...
/*======================================================================
 ...
 (function ($) {
    ...
    $(document).on('click', '.submit .btn', function () {
        ...
        if (name.trim() == "") {
            $('#name_error').html("Por favor escriba su Nombre.");
            valid = false;
        } else {
            $('#name_error').html("");
        }
        ...
        if (mail.trim() == "") {
            $('#email_error').html("Por favor escriba su email.");
            valid = false;
        } else if (!emailreg.test(mail)) {
            $('#email_error').html("Por favor escriba un email valido.");
            valid = false;
        } else {
            $('#email_error').html("");
        }
        ...
        if (phone.trim() == "") {
            $('#phone_error').html("Por Favor escriba su numero telefonico.");
            valid = false;
        } else {
            $('#phone_error').html("");
        }
        ...
        if (subject.trim() == "") {
            $('#subject_error').html("Por Favor escriba el asunto.");
            valid = false;
        } else {
            $('#subject_error').html("");
        }
        ...
        if (message.trim() == "") {
            $('#message_error').html("Por Favor escriba un mensaje.");
            valid = false;
        } else {
            $('#message_error').html("");
        }
